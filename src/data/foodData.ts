...
export const foodData: PetFood[] = [
  {
    ...
    description: 'Ultra-premium freeze-dried raw canine nutrition featuring grass-fed New Zealand venison, wild salmon oil, organic blueberries, and probiotics.',
  ...
  },
  {
    ...
    description: 'Decadent slow-cooked French duck breast paired with wild Pacific king salmon, infused with bone broth and essential taurine.',
